...
grails.plugins.springsecurity.x509.subjectDnRegex = 'EMAILADDRESS=(.*?)(?:,|$)'




grails.plugins.springsecurityx509.continueFilterChainOnUnsuccessfulAuthentication = false
...
log4j = {
	...
	debug 'org.springframework.security', 'grails.plugin.springsecurity','grails.app.controllers'
